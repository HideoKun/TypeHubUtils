...
it("should work", () => {
  expectTypeOf<{b: number, c: boolean}>().toEqualTypeOf<SafeOmit<ConsistentSimpleObject, 'a'>>();
  expectTypeOf<{c: boolean}>().toEqualTypeOf<SafeOmit<ConsistentSimpleObject, 'a' | 'b'>>();
